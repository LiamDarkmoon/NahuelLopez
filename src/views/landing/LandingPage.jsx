        ...
        <div id="Landing" className="pg text-center">
            ...
            <div ref={ projectsRef } className="pb-4">
                <div className="btn-container col-12 d-flex flex-column align-items-center">
                        ...
                        <article className="section-article ">
                            <div className="col-12 col-sm-4">
                                ...
                                <p>
                                    ...
                                    the CTAs are bright red inviting you to interact with them,
                                    i&apos;ve played a lot too with opacities making it more lenient and gaining depth
                                </p>
                            </div>
                            <img className="project-img col-12 col-sm-7" src="./landing.jpeg" alt="Landing Page"/>
                        </article>
                        <article className="section-article reverse">
                            <img className="project-img col-8 col-sm-5 mx-sm-0 mx-auto" src="./diceroller.jpeg" alt="Dice Tray" />
                            <div className="col-12 col-sm-4">
                                ...
                                <p>
                                    ...
                                    or at least to comply with the good practices, showcasing the product or service is part of these good practices,
                                    as i show here with the Dice tray. A friendly tool for those eager to play rol games right away and without a dice set.
                                    However it&apos;s purpose here is to showcase the product and give the customer a first-hand trial.
                                </p>
                            </div>
                        </article>
                        <article className="section-article">
                            <div className="col-12 col-sm-4">
                                ...
                                <p>
                                    As for the Sign up and sign in forms, those they are dispalyed on the navbar as buttons,
                                    they&apos;re dispalyed as modal windows as to ease the user to it&apos;s purpose, without interfering with the experience.
                                </p>
                            </div>
                            <img  className="project-img col-12 col-sm-7" src="./sign up.jpeg" alt="Sign Up Form"/>
                        </article>
                    </section>
                    ...
                    <button className="bttn col-6 col-sm-3" onClick={ scrollToTop }>
                        Go back to the top
